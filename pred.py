...
cfg = LazyConfig.load("/home/arina/repos/EVA/EVA-02/det/projects/ViTDet/configs/eva2_mim_to_coco/eva2_coco_cascade_mask_rcnn_vitdet_b_4attn_1024_lrd0p7.py")

# default_setup(cfg, )

out_dir = 'pred_kopter_winter_1024'
...
# DetectionCheckpointer(model).load('/home/arina/repos/EVA/EVA-02/det/res333/model_0021499.pth')  
DetectionCheckpointer(model).load('/home/arina/repos/EVA/EVA-02/det/outputs/bpla_winter_oil_1024/model_0001999.pth')  

os.makedirs(out_dir, exist_ok=True)
model.eval()
for i in glob.glob('/home/arina/projs/spils/winter3.0/yolo_0123/images/val/*'):
    img = cv2.imread(i)
    height, width = img.shape[:2]
    factor = max(height, width)/1024
